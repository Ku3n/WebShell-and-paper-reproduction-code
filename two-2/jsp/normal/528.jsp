...
<html>
<head>
	<title>Distribution mode list</title>
	...
	<script type="text/javascript" src="${ctx }/scripts/baseInfo/delivery/list_delivery.js"></script>
...
<!-- 语言设置-->
<input type="hidden" id="No" value="<s:text name="listdelivery.No"/>"/>	
<input type="hidden" id="Delivery" value="<s:text name="listdelivery.Delivery"/>"/>	
<input type="hidden" id="Distributioncosts" value="<s:text name="listdelivery.Distributioncosts"/>"/>	
...
<input type="hidden" id="Add" value="<s:text name="Add"/>"/>	
