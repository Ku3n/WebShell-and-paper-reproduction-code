...
<!-- saved from url=(0045)http://jianliben.sinaapp.com/sample/blockline -->
<html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
		...
		<link type="text/css" rel="stylesheet" href="./blockline/blockline.min.css">
		
		<script type="text/javascript" src="./blockline/browser.min.js"></script>
		...
		<script type="text/javascript" src="./blockline/context.min.js"></script>
		<script>
			context.host  = 'http://jianliben.sinaapp.com/';
			context.res   = 'http://jianliben.sinaapp.com/public/static/';
			context.tpl   = 'blockline';
			context.theme = '#5E8EE0';
			context.back  = '';
	...
	<body tpl="blockline" theme="#5E8EE0" back="">
		<!-- 移动设备检测 -->
...
<!-- template end -->	
			<div id="content" style="background:url(./images/tpl_bg.png) center 0px repeat-y;background-color:#FFF;">
				...
				<div id="content-theme" class="theme-color-pick" title="背景色">
					<script type="text/javascript" src="./blockline/jscolor.js"></script>
						...
						<tbody id="baseinfo">
							...
							<tr>
								<td class="field-value-td">									<span id="avater-wrapper">
										<img width="124" height="150" id="avater-img" src="./blockline/avater.gif">
	...
	<div id="field-clear-1"></div>								<span style="float:left;">
										...
										<p>
											<span class="baseinfo-label editable" contenteditable="true">生日：</span><span class="baseinfo-value editable editable-out" contenteditable="true">1989-xx-xx</span>
										...
										<p>
											<span class="baseinfo-label editable" contenteditable="true">性别：</span><span class="baseinfo-value editable editable-out" contenteditable="true">男</span>
											<span class="add-del-btn" style="visibility: hidden;"><a href="javascript:;" class="field-add-btn">＋</a><a href="javascript:;" class="field-del-btn">×</a></span>
										</p>
										<p>
											<span class="baseinfo-label editable" contenteditable="true">电话：</span><span class="baseinfo-value editable editable-out" contenteditable="true">15116444941</span>
											<span class="add-del-btn" style="visibility: hidden;"><a href="javascript:;" class="field-add-btn">＋</a><a href="javascript:;" class="field-del-btn">×</a></span>
										</p>
										<p>
											<span class="baseinfo-label editable editable-out" contenteditable="true">邮箱：</span><span class="baseinfo-value editable editable-out" contenteditable="true">maifute@163.com</span>
											<span class="add-del-btn" style="visibility: hidden;"><a href="javascript:;" class="field-add-btn">＋</a><a href="javascript:;" class="field-del-btn">×</a></span>
										</p>
										<p>
	...
	<div id="field-clear-2"></div>								<span style="float:left;">
										...
										<p>
											<span class="baseinfo-label editable" contenteditable="true">工作单位：</span><span class="baseinfo-value editable" contenteditable="true">xx公司</span>
											<span class="add-del-btn" style="visibility: hidden;"><a href="javascript:;" class="field-add-btn">＋</a><a href="javascript:;" class="field-del-btn">×</a></span>
										</p>
										<p>
											<span class="baseinfo-label editable" contenteditable="true">工作时间：</span><span class="baseinfo-value editable" contenteditable="true">2012.7 - 2013.7</span>
											<span class="add-del-btn" style="visibility: hidden;"><a href="javascript:;" class="field-add-btn">＋</a><a href="javascript:;" class="field-del-btn">×</a></span>
										</p>
										<p>
											<span class="baseinfo-label editable" contenteditable="true">应聘意向：</span><span class="baseinfo-value editable" contenteditable="true">前端开发，产品助理</span>
											<span class="add-del-btn" style="visibility: hidden;"><a href="javascript:;" class="field-add-btn">＋</a><a href="javascript:;" class="field-del-btn">×</a></span>
										</p>
									</span>
							...
							<tr>
								...
								<td class="field-value-td">
									<div class="field-value editable" contenteditable="true">
										...
										该应用是基于Web在线简历的制作工具，应用给用户提供在线的Web简历模板，用户可对简历进行高度灵活的所见即所得的编辑并实时保存；用户可将简历转换为PDF文件并下载、转换为Word文件下载；用户可将简历发送到指定邮箱而保持简历样式不变；用户可对简历进行在线打印。应用采用PHP脚本开发，开发过程中提炼出了一些JS公共组件：<a href="http://jianliben.sinaapp.com/sample/blockline#" target="_blank" title="DOM操作工具">fishJS</a>、<a href="http://jianliben.sinaapp.com/sample/blockline#" target="_blank" title="模态弹出框">fishBox</a>、<a href="http://jianliben.sinaapp.com/sample/blockline#" target="_blank" title="异步文件上传">fishUpload</a>、<a href="http://jianliben.sinaapp.com/sample/blockline#" target="_blank" title="富文本编辑器">fishEditor</a>。应用地址：jianliben.sinaapp.com。
									</div>
								</td>
							</tr>
						</tbody>
...
//					url    : "http://jianliben.sinaapp.com/resume/upload?from=tpl",
			...
			//默认头像
			$f.elem('#avater-img').setAttribute('src', '${contextPath}/resume/images/avater.gif');
		</script>
		
		<!-- the slider -->
		<link rel="stylesheet" type="text/css" href="./blockline/template.slider.min.css">
		<script type="text/javascript" src="./blockline/template.slider.min.js"></script>
