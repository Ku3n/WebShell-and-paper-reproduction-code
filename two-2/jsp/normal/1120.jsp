			...
			<table width="100%" cellpadding="1" cellspacing="1" border="0"
				...
				<table width="100%" cellpadding="0" cellspacing="1" border="0"
					...
					<tr>
						...
						<td width="30%">
							<input name="case_title" id="case_title" type="text" value="<%=case_title %>" />
						</td>
						<td align="right" width="10%">
							涉案地点
							<font color="red">*</font>
...
<tr>
					...
					<td width="30%">
						<input type="text" id="delegate_tel" name="delegate_tel" value="<%=delegate_tel %>" onKeyUp="if(isNaN(value))this.value=''">
					</td>
					...
					<td width="30%">
						<input type="text" id="delegate_name" name="delegate_name" value="<%=delegate_name %>">
					</td>
				</tr>
				<tr>
		<td align="right" width="10%">
					...
					<td  width="30%"><input type="text" name="delegate_fee" id="delegate_fee" value="<%=delegate_fee %>"></td>
				</tr>
<tr>
					<td align="right" width="10%">
						案源级别
					...
					<td>
						<select id="memberscurrency_id" name="memberscurrency_id" >
							<option value="">请选择</option>
							<%=selelctlist%>
						</select>
						<input type="hidden" name="case_level" id="case_level" value="<%=memberscurrency_id %>" >
					</td>
					...
					<tr>
						...
						<td>
							<input name="case_desc" id="case_desc" type="text" value="<%=case_desc %>" >
						</td>
					</tr>
						<tr>
						<td align="right" width="10%">
						...
						<td colspan="3">
							<input name="case_amount" id="case_amount" type="text" value="<%=case_amount %>" onKeyUp="if(isNaN(value))this.value=''"/>
						</td>
					<!-- 
						<td align="right" width="10%">
							涉案时间
					...
					<tr>
						...
						<td colspan="3">
							<textarea name="case_content" id="case_content"><%=case_content %></textarea>
							<script type="text/javascript"
			   ...
			   CKEDITOR.replace( 'case_content',{});  
				...
				<table width="100%" cellpadding="0" cellspacing="0" border="0">
					<tr>
						<td align="center">
							<input type="hidden" name="case_state" value="<%=case_state%>">
							<input type="hidden" name="case_id" value="<%=case_id%>">
							<input type="hidden" name="bpm_id" value="0463" />
							<input type="hidden" name="contact_sum" id="contact_sum" value="<%=contact_sum %>" >
