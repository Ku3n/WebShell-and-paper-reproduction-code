...
<!-- saved from url=(0043)http://jianliben.sinaapp.com/sample/default -->
<html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<link type="text/css" rel="stylesheet" href="${contextPath}/resume/style/common.min.css">
		<link type="text/css" rel="stylesheet" href="./default/default.min.css">
		
		<script type="text/javascript" src="./default/browser.min.js"></script>
		...
		<script type="text/javascript" src="./default/context.min.js"></script>
		<script>
	...
	<body tpl="default" theme="#B4C9CE" back="">
		<!-- 移动设备检测 -->
...
<!-- template end -->	
			<div id="content" style="background:url(./images/tpl_bg.png) center 0px repeat-y;background-color:#FFF;">
				...
				<div id="content-theme" class="theme-color-pick" title="背景色">
					<script type="text/javascript" src="./default/jscolor.js"></script>
	...
	<div id="field-clear-1"></div>								<span style="float:left;">
										...
										<p>
											<span class="baseinfo-label editable editable-out" contenteditable="true">学历：</span><span class="baseinfo-value editable editable-out" contenteditable="true">本科</span>
											<span class="add-del-btn" style="visibility: hidden;"><a href="javascript:;" class="field-add-btn">＋</a><a href="javascript:;" class="field-del-btn">×</a></span>
										</p>
									</span>
	<div id="field-clear-2"></div>								<span style="float:left;">
										...
										<p>
											<span class="baseinfo-label editable" contenteditable="true">应聘意向：</span><span class="baseinfo-value editable editable-out" contenteditable="true">前端开发，产品助理</span>
											<span class="add-del-btn" style="visibility: hidden;"><a href="javascript:;" class="field-add-btn">＋</a><a href="javascript:;" class="field-del-btn">×</a></span>
										</p>
									</span>
						...
						<tbody>
							<tr>
								...
								<td class="field-value-td">
									<div class="field-value editable editable-out" contenteditable="true">
							...
							<tr>
								...
								<td class="field-value-td">
									<div class="field-value editable editable-out" contenteditable="true">
										...
										该应用是基于Web在线简历的制作工具，应用给用户提供在线的Web简历模板，用户可对简历进行高度灵活的所见即所得的编辑并实时保存；用户可将简历转换为PDF文件并下载、转换为Word文件下载；用户可将简历发送到指定邮箱而保持简历样式不变；用户可对简历进行在线打印。应用采用PHP脚本开发，开发过程中提炼出了一些JS公共组件：<a href="http://jianliben.sinaapp.com/sample/default#" target="_blank" title="DOM操作工具">fishJS</a>、<a href="http://jianliben.sinaapp.com/sample/default#" target="_blank" title="模态弹出框">fishBox</a>、<a href="http://jianliben.sinaapp.com/sample/default#" target="_blank" title="异步文件上传">fishUpload</a>、<a href="http://jianliben.sinaapp.com/sample/default#" target="_blank" title="富文本编辑器">fishEditor</a>。应用地址：jianliben.sinaapp.com。
									</div>
								</td>
							</tr>
						</tbody>
						<tbody>
							<tr>
								<td class="field-title-td">
									<div class="field-title-wrap">
										<div class="field-title editable editable-out" contenteditable="true"><b><span style="font-size: 15px;"><font color="#660000">教育经历</font></span></b></div>
									</div>
									<div class="add-del-btn" style="visibility: hidden;">
										<a href="javascript:;" class="field-add-btn">＋</a><a href="javascript:;" class="field-del-btn">×</a>
									</div>
...
//					url    : "http://jianliben.sinaapp.com/resume/upload?from=tpl",
		...
		<!-- the slider -->
		<link rel="stylesheet" type="text/css" href="./default/template.slider.min.css">
		<script type="text/javascript" src="./default/template.slider.min.js"></script>
