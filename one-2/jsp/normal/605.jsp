...
<form:form id="resultForm" name="resultForm" commandName="role">
        <div class="title"><fmt:message key="new.role"/></div>
						<table class="yTable margintop">   
			<tr>
			    <th align="right" width="120"><span>*</span><fmt:message key="role.name"/> </th>
				<td align="left"><input name="name" id="name" type="text"  class="inputbox"/><span></span>
				</td>
			</tr>
			<tr>
				...
				<select name="level">  
				 ...
				 <option selected="selected" value="2"><fmt:message key="common.user"/></option>
				</select>
				</td>
			</tr>
			<!--  <tr>
...
<script type="text/javascript">
seajs.use("${scriptBasePath}/role/new.js");
</script>
</body>
</html>