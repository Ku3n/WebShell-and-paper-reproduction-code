...
<%
		...
		else
		{
			...
			{
				index_temp="/8diansp/index.html";
			}
			else
			{	
				index_temp="/business/index.html";
			}
		}
	 %>
<h1>首页更新设置</h1>
<form action="create_index.jsp" method="post" name=updateForm enctype="multipart/form-data">
  <table width="100%" cellpadding="0" cellspacing="1" border="0" class="listtab">
    ...
    <tr>
     ...
     <%
	     	if(req_url.indexOf("8diansp.com")!=-1)
				{
     %> 
			 <a href="#" onclick="updateIndex('/8diansc/index.html','/data/','8diansc.html')"><img src="/program/admin/index/images/8diansc.gif"></a>
			 <a href="#" onclick="updateIndex('/8diansp/index.html','/','index.html')"><img src="/program/admin/index/images/8diansp.gif"></a>
      <%
	      }
	     	else
	     	{     	
       %>
        <a href="#" onclick="updateIndex('/business/index.html','/','index.html')"><img src="/program/admin/index/images/business.gif"></a> 
       <%
       	}
       %>
	</td>
    ...
    <!--
      ...
      <select name="selects">
          <option value="/" selected="selected">全部更新</option>
          <option value="/8diansc/index.html">8点商城</option>
          <option value="/8diansp/index.html">8点商铺</option>
          <option value="/business/index.html">金色钥匙</option>
        </select>
        <input type="button" name="delInfo"  onclick="updateIndex(1)" value="快速更新" class="buttab"/></td>
    </tr>
	-->
