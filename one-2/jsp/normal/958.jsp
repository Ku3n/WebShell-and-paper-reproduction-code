...
<TABLE align="center" height="100%" cellSpacing=0 cellPadding=0 width="80%" border=0>
  ...
  <TR>
    ...
    <s:form action="Student_QQ287307421/Student_QQ287307421_AddStudent_QQ287307421.action" method="post" id="student_QQ287307421AddForm" onsubmit="return checkForm();"  enctype="multipart/form-data" name="form1">
<table width='100%' cellspacing='1' cellpadding='3' class="tablewidth">
  ...
  <tr>
    <td width=30%>家庭地址:</td>
    <td width=70%><textarea id="student_QQ287307421.studentAddress" name="student_QQ287307421.studentAddress" rows="5" cols="50"></textarea></td>
  </tr>

  <tr>
    <td width=30%>附加信息:</td>
    <td width=70%><textarea id="student_QQ287307421.studentMemo" name="student_QQ287307421.studentMemo" rows="5" cols="50"></textarea></td>
  </tr>
