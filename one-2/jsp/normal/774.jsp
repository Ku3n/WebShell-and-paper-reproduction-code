...
<table border="0" cellpadding="0" cellspacing="0" class="tb_style">
  <form name="shanpayment" action="shanpay.do" method="post" target="_blank">
    ...
    <tr>
      ...
      <td height="80" colspan="2"  class="td_border"><textarea name="WIDbody" cols="35" rows="10" class="L_r_content">云通付收银助你秒开发，10分钟即可快速接入支付功能，缩短2~4个月开发周期；PC网页、手机网页、移动应用、iOS/ Android/HTML5/App等全平台支持....</textarea></td>
    </tr>
    <tr>
