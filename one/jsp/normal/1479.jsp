...
//out.print(filelist);
	...
	String content = "" ,templateDir =rootpath+"templets/html/www/"+filelist;
	//templateDir =rootpath+"templets/html"+file_path+filelist;
	//out.println("路径--------------"+templateDir);
...
//content = fileio.LoadFile(templateDir);
   ...
   */
		...
		if(m.matches()){
				content	="<img src='/templets/html/404_01.jpg' />";
			}else{
				content = fileio.LoadFile(templateDir);
		}
