...
<input type="hidden" value="${contextPath }<ifa:constant fieldName='DEFAULT_THIRD_DISTRICT_CONDTION_URL' namespace='cim' />" id="districtCondtion" >
<input type="hidden" value="${topMenu}" id="topMenuId"/>
<input type="hidden" value="${sideMenu}" id="leftMenuId"/>    
		<span style="padding-right:30px;color:#ffdd00">
		    <a href="${contextPath}/changeloglatest.jsp" target="_blank" >新功能</a>&nbsp;
<%-- 			<a href="http://10.204.130.45:8090/display/cim2help/Home" target="_blank" >帮助</a>&nbsp;
			<a href="http://10.204.130.50:8080/secure/CreateIssue!default.jspa" target="_blank" ><fmt:message key='header.report' /></a> --%>&nbsp;&nbsp;
			<font color="red">测试环境！！</font>&nbsp;&nbsp;
			<a href="${contextPath}/j_spring_security_logout">退出</a>
			| <a href="#" id="editPassword">修改密码</a>&nbsp;
			<a href="#" id ="editDefaultDistrict">默认门店</a>&nbsp;&nbsp;
			<span style="color:#fff">陈意：<security:authentication property="principal.Username"/>&nbsp;
			老师<security:authentication property="principal.roleNames"  /></span>
		</span> 
	</div>
<div class="logo">
