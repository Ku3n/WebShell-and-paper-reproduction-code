...
<% 
	...
	String custTypeSelect = new Tb_commparaInfo().getSelectItem("12","");
 %>
...
<body>
	...
	<!--用户资料管理-->	
			<tr>
				<td colspan="4">
			   &nbsp;&nbsp;<img src="/program/admin/images/infotip.gif" border="0">&nbsp;&nbsp;<span style="font-size:14px;font-weight:bold;">企业账户信息</span>			</td>
		    </tr>	
			...
			<td  width="20%"><input name="user_name" id="user_name" type="text" maxlength="20"   onblur="return checkname(this.value)"/></td>
			<td align="right" width="15%">
		...
		<tr>
			...
			<td  colspan="3"><input name="short_name" id="short_name" type="text"  maxlength="40" size="30" />在8点商铺平台作为企业店铺名称</td>
		</tr>
		...
		<tr>
			...
			<div id="xiaoshou" style="float:left;display:inline;white-space:nowrap">
				...
				<input type="text" style="color:#999999" name="company_supply" id="company_supply" />
			</div>
			<div id="caigou" style="display:none;float:left;white-space:nowrap">
				<font color="red">采购</font>产品
				<input type="text" style="color:#999999" name="company_stock" id="company_stock"   />
			</div>
		...
		<tr>
			...
			<td><input name="contact_cellphone" id="contact_cellphone" type="text"  maxlength="25" onkeyup="if(isNaN(this.value))this.value=''"/></td>
		</tr>
		...
		<tr>
			...
			<td><input name="contact_qq" id="contact_qq" type="text"   maxlength="25" onkeyup="if(isNaN(this.value))this.value=''"/></td>
		</tr>
		...
		<tr>
			...
			<td><input name="post_code" id="post_code" type="text"  maxlength="25" onkeyup="if(isNaN(this.value))this.value=''"/></td>
		...
		<tr>
			...
			<td><input name="reg_money" id="reg_money" type="text"  maxlength="25" onkeyup="if(isNaN(this.value))this.value=''"/></td>
		</tr>
		...
		<tr>
			...
			<td><input name="reg_date" id="reg_date" type="text"  maxlength="25" value="2010-10-10" class="Wdate" onclick="WdatePicker({readOnly:true})"/></td>
		...
		<tr>
			...
			<td><input name="bank_no" id="bank_no" type="text" maxlength="25" onkeyup="if(isNaN(this.value))this.value=''"/></td>
		</tr>
		...
		<tr>
			...
			<td><input name="make_sum" id="make_sum" type="text"  maxlength="25" onkeyup="if(isNaN(this.value))this.value=''"/></td>
	
			<td align="right" width="10%">
				雇员人数:
			</td>
			<td><input name="staff_num" id="staff_num" type="text"  maxlength="25" onkeyup="if(isNaN(this.value))this.value=''"/></td>
		</tr>
		...
		<tr>
			...
			<td><input name="kwo_num" id="kwo_num" type="text"  maxlength="25" onkeyup="if(isNaN(this.value))this.value=''"/></td>
		...
		<tr>
			...
			<td><input name="month_sum" id="month_sum" type="text"  maxlength="25" onkeyup="if(isNaN(this.value))this.value=''"/></td>
		...
		<tr>
			...
			<td><input name="year_in" id="year_in" type="text"  maxlength="25" onkeyup="if(isNaN(this.value))this.value=''"/></td>
		
			<td align="right" width="10%">
				年出口额:
			</td>
			<td><input name="year_out" id="year_out" type="text"  maxlength="25" onkeyup="if(isNaN(this.value))this.value=''"/></td>
		</tr>
		...
		<tr>
			...
			<td><input name="year_sum" id="year_sum" type="text"  maxlength="25" onkeyup="if(isNaN(this.value))this.value=''"/></td>
	...
	<!--企业级别管理-->	
			...
			<tr>
				<td colspan="4">
			   &nbsp;&nbsp;<img src="/program/admin/images/infotip.gif" border="0">&nbsp;&nbsp;<span style="font-size:14px;font-weight:bold;">企业级别信息</span>			</td>
		    </tr>	
			...
			<tr>
				...
				<td colspan="3">
				<select  name="user_class" id="user_class"   width="30" disabled="disabled">
					<%=custclass_select%>
				</select>
	...
	<table width="100%" cellpadding="0" cellspacing="0" border="0">
		<tr>
			<td align="center">
				...
				<input type="button"   class="buttoncss"  onclick="submitForm('add')" value="提交" />&nbsp;&nbsp;
				<input type="button"   class="buttoncss" value="返回" onclick="window.location.href='/program/admin/memberqiye/index.jsp';"/>
			</td>
		</tr>
	</table>
	</form>
