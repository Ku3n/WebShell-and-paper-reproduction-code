...
<table width='100%' cellspacing='1' cellpadding='3' class="tablewidth">
  ...
  <tr>
    <td width=30%>家庭地址:</td>
    <td width=70%><textarea id="teacher_QQ287307421.teacherAddress" name="teacher_QQ287307421.teacherAddress" rows="5" cols="50"></textarea></td>
  </tr>

  <tr>
    <td width=30%>附加信息:</td>
    <td width=70%><textarea id="teacher_QQ287307421.teacherMemo" name="teacher_QQ287307421.teacherMemo" rows="5" cols="50"></textarea></td>
  </tr>
