					...
					<form id="saveForm" method="post" action="">
				    	...
				    	<table width="100%"  border="0" cellpadding="0" cellspacing="1" class="gdcn-table-bgcolor">
					    	<tr>
								...
								<td class='gridbody'>					
									<input type="text" id="code" name="dictionaryItem.code" maxlength="20" value="${dictionaryItem.code}" onchange="codeCheck()" />
								</td>
							</tr>
							<tr>
								<td class='gridtitle'>值：</td>
								<td class='gridbody'>
									<input type="text" id="name" name="dictionaryItem.name" maxlength="20" value="${dictionaryItem.name}"/>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class='gridbody'>
									<input type="text" id="sort" name="dictionaryItem.sort" maxlength="20" value="${dictionaryItem.sort}"/>
								</td>
							</tr>
						</table>
