...
if __name__ == "__main__":
    ...
    parser.add_argument('--normal_php', type=str, required=True, help='正常PHP文件目录')
    parser.add_argument('--malicious_php', type=str, required=True, help='恶意PHP文件目录')
    parser.add_argument('--normal_jsp', type=str, required=True, help='正常JSP文件目录')
    parser.add_argument('--malicious_jsp', type=str, required=True, help='恶意JSP文件目录')
