...
<link rel="stylesheet" type="text/css" href="${ctx}/styles/jqPager/Pager.css" /><!-- 分页 --> 
	...
	<input id="apptype" name="apptype" value="recevied" type="hidden" />
...
<!-- 收件信息 -->
   ...
   <div class="gdttda">
         <div class="hyzx_bt">
	       <div class="zxyc_dh">
		       <div class="zxyc_zz">信息列表</div>
		       <div class="sr3_t_right right"></div>
	       </div>
	       
	       <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" class="huisesibiankuang">
			   <tr>
							            ...
							            <td height="33" align="center" background="${ctx }/styles/front/images/dingdanzhongxin2222_08.gif">
								            <table width="100%" height="17" border="0" cellpadding="0" cellspacing="0">
								              <tr>
								              	...
								              	<td width="100" align="center">发件人</td>
