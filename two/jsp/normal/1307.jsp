...
<% 
	...
	String para = "/program/admin/product/index.jsp?s_title="+s_title+"&state_c="+state_c+"&info_state="+info_state+"&iStart="+Integer.parseInt(iStart);		 
  	
	Ts_categoryInfo ts_categoryInfo = new Ts_categoryInfo();
  	Map catMap = ts_categoryInfo.getCatClassMap("2");
  	
  	String cust_id="",title="",product_desc="",class_attr="",area_attr="",state_code="",attr_desc="",user_id="",publish_date="",remark="";
...
<body>
	...
	<form action="/doTradeReg.do" method="post" name="addForm">
		<table width="100%" cellpadding="1" cellspacing="1" border="0" class="listtab">
			...
			<td  colspan="3">
			   <font color="red"><%=cat_names%></font> 
				 &nbsp;&nbsp;<input class="button_css" type="button" value ="返回，重新选择类目" onclick="window.location.href='addInfo.jsp?flag_code=1&product_id=<%=product_id%>'">	
			</td>
		</tr>
		...
		<tr>
			...
			<td colspan="3">
			  <textarea name="product_desc"><%=product_desc%></textarea>
	...
	<table width="100%" cellpadding="0" cellspacing="0" border="0">
		<tr>
			<td align="center">
				<input type="hidden" name="bpm_id" value="2040" />
