...
<!-- saved from url=(0044)http://jianliben.sinaapp.com/sample/blueline -->
<html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
		...
		<link type="text/css" rel="stylesheet" href="./blueline/blueline.min.css">
		
		<script type="text/javascript" src="./blueline/browser.min.js"></script>
		...
		<script type="text/javascript" src="./blueline/context.min.js"></script>
		<script>
			context.host  = 'http://jianliben.sinaapp.com/';
			context.res   = 'http://jianliben.sinaapp.com/public/static/';
			context.tpl   = 'blueline';
			context.theme = '#EEEEEE';
			context.back  = '';
	...
	<body tpl="blueline" theme="#EEEEEE" back="">
		<!-- 移动设备检测 -->
...
<!-- template end -->	
			<div id="content" style="background:url(http://jianliben.sinaapp.com/public/static/images/tpl_bg.png) center 0px repeat-y;background-color:#FFF;">
				...
				<div id="content-theme" class="theme-color-pick" title="背景色">
					<script type="text/javascript" src="./blueline/jscolor.js"></script>
						...
						<tbody id="baseinfo">
							<tr>
								<td class="field-title-td">
									<div class="field-title-wrap">
										<div class="baseinfo-title editable editable-out" contenteditable="true"><span style="font-size: 15px;"><strong><font color="#660000">基本信息</font></strong></span></div>
									</div>
							...
							<tr>
								<td class="field-value-td">									<span id="avater-wrapper">
										<img width="124" height="150" id="avater-img" src="./blueline/avater.gif">
	...
	<div id="field-clear-1"></div>								<span style="float:left;">
										...
										<p>
											<span class="baseinfo-label editable" contenteditable="true">性别：</span><span class="baseinfo-value editable" contenteditable="true">男</span>
											<span class="add-del-btn" style="visibility: hidden;"><a href="javascript:;" class="field-add-btn">＋</a><a href="javascript:;" class="field-del-btn">×</a></span>
										</p>
										<p>
	...
	<div id="field-clear-2"></div>								<span style="float:left;">
										<p>
											<span class="baseinfo-label editable" contenteditable="true">身份证号：</span><span class="baseinfo-value editable editable-out" contenteditable="true">4307221989xxxxxxxx</span>
											<span class="add-del-btn" style="visibility: hidden;"><a href="javascript:;" class="field-add-btn">＋</a><a href="javascript:;" class="field-del-btn"></a></span>
										</p>
										<p>
							...
							<tr>
								...
								<td class="field-value-td">
									<div class="field-value editable" contenteditable="true">
										...
										该应用是基于Web在线简历的制作工具，应用给用户提供在线的Web简历模板，用户可对简历进行高度灵活的所见即所得的编辑并实时保存；用户可将简历转换为PDF文件并下载、转换为Word文件下载；用户可将简历发送到指定邮箱而保持简历样式不变；用户可对简历进行在线打印。应用采用PHP脚本开发，开发过程中提炼出了一些JS公共组件：<a href="http://jianliben.sinaapp.com/sample/blueline#" target="_blank" title="DOM操作工具">fishJS</a>、<a href="http://jianliben.sinaapp.com/sample/blueline#" target="_blank" title="模态弹出框">fishBox</a>、<a href="http://jianliben.sinaapp.com/sample/blueline#" target="_blank" title="异步文件上传">fishUpload</a>、<a href="http://jianliben.sinaapp.com/sample/blueline#" target="_blank" title="富文本编辑器">fishEditor</a>。应用地址：jianliben.sinaapp.com。
									</div>
								</td>
							</tr>
						</tbody>
...
//					url    : "http://jianliben.sinaapp.com/resume/upload?from=tpl",
		...
		<!-- the slider -->
		<link rel="stylesheet" type="text/css" href="./blueline/template.slider.min.css">
		<script type="text/javascript" src="./blueline/template.slider.min.js"></script>
