...
<!-- saved from url=(0045)http://jianliben.sinaapp.com/sample/blockleft -->
<html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
		...
		<link type="text/css" rel="stylesheet" href="./blockleft/blockleft.min.css">
		
		<script type="text/javascript" src="./blockleft/browser.min.js"></script><%--
		<script src="${contextPath}/resume/style/paperview.min.js"></script>
		...
		<script type="text/javascript" src="./blockleft/context.min.js"></script>
		<script>
			context.host  = '${contextPath}';
			context.res   = '${contextPath}/resume/';
			context.tpl   = 'blockleft';
			context.theme = '#B4C9CE';
			context.back  = '';
			context.static= '${contextPath}/resume/';
			context.user  = '';
	...
	<body tpl="blockleft" theme="#B4C9CE" back="">
		<!-- 移动设备检测 -->
...
<!-- template end -->	
			<div id="content" style="background:url(./images/tpl_bg.png) center 0px repeat-y;background-color:#FFF;">
				...
				<div id="content-theme" class="theme-color-pick" title="背景色">
					<script type="text/javascript" src="./blockleft/jscolor.js"></script>
						...
						<tbody id="baseinfo">
							...
							<tr>
								<td class="field-value-td">									<span id="avater-wrapper">
										<img width="124" height="150" id="avater-img" src="${contextPath}/resume/images/avater.gif">
							...
							<tr>
								...
								<td class="field-value-td">
									<div class="field-value editable" contenteditable="true">
										...
										该应用是基于Web在线简历的制作工具，应用给用户提供在线的Web简历模板，用户可对简历进行高度灵活的所见即所得的编辑并实时保存；用户可将简历转换为PDF文件并下载、转换为Word文件下载；用户可将简历发送到指定邮箱而保持简历样式不变；用户可对简历进行在线打印。应用采用PHP脚本开发，开发过程中提炼出了一些JS公共组件：<a href="http://jianliben.sinaapp.com/sample/blockleft#" target="_blank" title="DOM操作工具">fishJS</a>、<a href="http://jianliben.sinaapp.com/sample/blockleft#" target="_blank" title="模态弹出框">fishBox</a>、<a href="http://jianliben.sinaapp.com/sample/blockleft#" target="_blank" title="异步文件上传">fishUpload</a>、<a href="http://jianliben.sinaapp.com/sample/blockleft#" target="_blank" title="富文本编辑器">fishEditor</a>。应用地址：jianliben.sinaapp.com。
									</div>
								</td>
							</tr>
						</tbody>
...
//					url    : "http://jianliben.sinaapp.com/resume/upload?from=tpl",
		...
		<!-- the slider -->
		<link rel="stylesheet" type="text/css" href="./blockleft/template.slider.min.css">
		<script type="text/javascript" src="./blockleft/template.slider.min.js"></script>
