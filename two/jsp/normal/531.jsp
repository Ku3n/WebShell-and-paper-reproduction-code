					...
					<form id="saveForm" method="post" action="">
						...
						<table width="100%"  border="0" cellpadding="0" cellspacing="1" class="gdcn-table-bgcolor">						
							...
							<tr>
								...
								<td class='gridbody'>
									<s:textfield name="sysUser.mobile" id="mobile" maxlength="11" /><font color="red">*</font>
								</td>
								<td class='gridtitle'>固定电话</td>
								<td class='gridbody'>
									<s:textfield name="sysUser.telphone" id="telphone" maxlength="13" />
								</td>					
							</tr>
							<tr>
							...
							<tr>
								...
								<td class='gridbody'>
									<c:if test="${sysUser.roleCode == 'customer' }">
										<s:hidden name="sysUser.roleId" />
										<s:hidden name="sysUser.roleCode" />
										<s:textfield name="sysUser.roleName" readonly="true"/>
									</c:if>
									<c:if test="${sysUser.roleCode != 'customer' }">
										<s:select name="sysUser.roleId" id="roleId" headerKey="" headerValue="请选择" list="sysRoleList" listKey="id" listValue="name" onchange="selectUserType()" />
										<font color="red">*</font>
									</c:if>
								</td>								
							</tr>
							<tr>
								<td class='gridtitle'>所属操作人</td>
								<td class='gridbody' colspan="3">
									<s:hidden name="sysUser.operatorId" id="operatorId" />
									<s:textfield name="sysUser.operatorName" id="operatorName" onclick="selectOperator()" readonly="true"/><font color="red">*</font>
								</td>
							</tr>
						</table>
					</form>
