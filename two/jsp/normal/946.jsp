...
<table width='100%' cellspacing='1' cellpadding='3'  class="tablewidth">
  ...
  <tr>
    ...
    <td width=70%><%=teacherBirthdaySDF.format(teacher_QQ287307421.getTeacherBirthday()) %></td>
  </tr>

  <tr>
    <td width=30%>入职日期:</td>
        <% java.text.DateFormat teacherArriveDateSDF = new java.text.SimpleDateFormat("yyyy-MM-dd");  %>
    <td width=70%><%=teacherArriveDateSDF.format(teacher_QQ287307421.getTeacherArriveDate()) %></td>
  </tr>
